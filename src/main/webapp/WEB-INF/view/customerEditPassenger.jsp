	...
	<div id="loginbox" style="margin-top: 50px;"
		...
		<div class="panel panel-primary">
			...
			<div class="panel-heading"
				style="color: white; background-color: #124512">
				<div class="panel-title">EDIT PASSENGER</div>
			</div>
			...
			<div style="padding-top: 30px" class="panel-body">
				...
				<!-- Registration Form -->
				<form:form
					action="${pageContext.request.contextPath}/customer/flight/book/addPassenger/${flightId}"
					...
					<div style="margin-bottom: 25px" class="input-group">
						...
						<form:input type="email" path="email" placeholder="Email" class="form-control" autocomplete="off" />
					</div>
