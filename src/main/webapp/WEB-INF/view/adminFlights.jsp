			...
			<c:forEach var="flightList" items="${flight}">
				<tbody>
					<tr>
						...
						<td><a
							href="
						<c:url value="${pageContext.request.contextPath}/admin/passengers/${flightList.flightId}" />"><button
									type="button" 
									style="color: white; background-color: #124512">Passenger</button></a></td>
						<td><a
							href="${pageContext.request.contextPath}/admin/flight/delete/${flightList.flightId}"><button
									type="button" 
									onclick="alert('Are you sure to cancel this flight?')"
									style="color: white; background-color: #124512">Cancel</button></a></td>
					</tr>
				</tbody>
			</c:forEach>
		</table>
